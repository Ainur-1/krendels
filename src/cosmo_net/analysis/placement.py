...
На сценарии 01 сеть цела, и место почти ничего не решает: разница между лучшим и
худшим узлом сетки — 1.11 процентного пункта, полный максимум 97.78 % дают 164 точки
из 192, а выше 75° широты — все двадцать четыре долготы. Трафику всё равно, где
приземляться, если сеть довезёт его куда угодно. На сценарии 04, где внутриплоскостные
связи распались, та же разница составляет 32.2 пункта: 94.4 % на 70° с. ш. против
62.2 % в худшем месте. И там же видно, что выбранный соображением Норильск даёт
95.8 %, то есть лучше любого узла сетки: перебор ничего не улучшил, а подтвердил.
"""
