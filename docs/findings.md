...
| 01 | C70 | 1.2 % | 68.2 % | 30.5 % | 1.29 |
| 01 | C72 | 1.1 % | 61.7 % | 37.3 % | 1.40 |
...
Ценность в форме поверхности, и она зависит от состояния межспутниковой сети. На сценарии 01 сеть цела, и второй шлюз даёт 97.8 % **из любой точки сетки**, хоть посреди Тихого океана: трафику всё равно, где приземляться, если сеть довезёт его куда угодно. На сценарии 04, где внутриплоскостные связи распались, место решает всё — 94.4 % на 70° с. ш. против 65.8 % на 50°, и тёмное пятно на карте приходится ровно на район клиентов.
